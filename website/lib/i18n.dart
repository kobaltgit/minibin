...
class S {
  ...
  static String get heroBadge => isRu
      ? 'MiniBin v2.0.2 Релиз доступен — Нативный Rust, Tauri v2 & Svelte 5'
      : 'MiniBin v2.0.2 Release Available — Native Rust, Tauri v2 & Svelte 5';
  ...
  static String get faqA2 => isRu
      ? 'Скачайте MiniBin_2.0.2_Portable.zip, распакуйте в любую папку или на флешку. Наличие файла portable.txt указывает программе хранить все настройки и кастомные иконки в этой же папке.'
      : 'Download MiniBin_2.0.2_Portable.zip, unpack anywhere or onto a flash drive. The presence of portable.txt tells MiniBin to keep all settings and icons locally in that folder.';
